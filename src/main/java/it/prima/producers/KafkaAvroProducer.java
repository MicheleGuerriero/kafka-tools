...
public class KafkaAvroProducer {
    ...
    public static void publishMessage(KafkaProducer producer, String topic, String messageKey, GenericRecord message) {
        ProducerRecord<Object, Object> record = new ProducerRecord<>(topic, messageKey, message);
